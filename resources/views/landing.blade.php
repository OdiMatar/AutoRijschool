<x-layout title="Rijschool Vierkante Wielen">
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('register') }}" class="btn btn-warning btn-lg fw-semibold shadow">Direct inschrijven</a>
                    <a href="{{ route('login') }}" class="btn btn-outline-light btn-lg shadow-sm">Inloggen leerling/instructeur</a>
                </div>
            </div>
            <div class="col-lg-5">
    ...
    <section class="rounded-4 p-4 p-lg-5 shadow-sm" style="background: linear-gradient(110deg, #fef08a 0%, #fdba74 45%, #f97316 100%);">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-lg-4 text-lg-end">
                <a href="{{ route('register') }}" class="btn btn-dark btn-lg shadow">Start je inschrijving</a>
            </div>
        </div>
    </section>
</x-layout>
