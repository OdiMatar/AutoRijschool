...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Registreren']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Registreren']); ?>
        ...
        <div class="card shadow-sm" style="max-width: 460px; width: 100%;">
            ...
            <form method="post" action="<?php echo e(route('register.store')); ?>" class="d-grid gap-3">
                ...
                <label class="form-label mb-0">
                    Naam
                    <input class="form-control mt-1" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <label class="form-label mb-0">
                    E-mailadres
                    <input class="form-control mt-1" type="email" name="email" value="<?php echo e(old('email')); ?>" required>
                ...
                <label class="form-label mb-0">
                    ...
                    <select class="form-select mt-1" name="role" required>
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>" <?php if(old('role', 'instructeur') === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="mt-3 mb-0">Heb je al een account? <a href="<?php echo e(route('login')); ?>">Inloggen</a></p>
            </div>
        </div>
    </section>
...
<?php endif; ?>
<?php /**PATH C:\project\VierKanteWielen\resources\views/auth/register.blade.php ENDPATH**/ ?>